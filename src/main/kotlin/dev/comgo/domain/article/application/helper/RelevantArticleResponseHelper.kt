package dev.comgo.domain.article.application.helper

import dev.comgo.domain.article.domain.entity.RelevantArticleEntity
import dev.comgo.domain.article.domain.repository.ArticleRepository
import dev.comgo.domain.article.domain.repository.RelevantArticleRepository
import dev.comgo.domain.article.presentation.dto.response.RelevantArticleResponse
